...
const NormalCard = ({ stat, text, bg, Icon }: CardProps) => {
    return (
        <div className={`flex flex-col bg-gradient-to-br  h-full rounded-lg relative overflow-hidden w-full shadow-lg z-10 ${bg} p-4`}>
            ...
            <div className='absolute opacity-20 text-[190px] -z-10 w-20 -ml-9 -mt-1'>
                <Icon />
            </div>
        </div>
    )
