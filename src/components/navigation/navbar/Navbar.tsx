...
const Navbar = () => {
  ...
  return (
    <nav className=" h-20  px-2 sm:px-4 py-2.5  top-0 left-0">
      <div className="flex md:order-2">
        <button onClick={setUpSidebar} aria-controls="separator-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-emerald-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:bg-green-800 dark:text-emerlad-400 dark:hover:bg-emerald-950 dark:focus:ring-emerald-600">
