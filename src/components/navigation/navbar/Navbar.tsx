  ...
  return (
    <nav className="block h-12 w-full  top-0 left-0">
      <div className="flex md:order-2">
        <button onClick={setUpSidebar} aria-controls="separator-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-emerald-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 bg-green-800 text-emerlad-400 hover:bg-emerald-950 focus:ring-emerald-600">
